...
\usepackage{csquotes}               % For quotations, mainly the \enquote command
...
\DeclareQuoteAlias{english}{dutch}             % Use English quotations instead of Dutch
...
\setmainfont{Ubuntu}  % YOU MUST HAVE THIS FONT INSTALLED (downloadable through Google fonts)
\setmonofont{Ubuntu}
...
\begin{document}
	%% TITLE %%
	\begin{figure}
		\includegraphics[width=0.27\textwidth,keepaspectratio]{figuren/logo} % Lab9K Logo
	\end{figure}
	\vspace*{0.35cm}
